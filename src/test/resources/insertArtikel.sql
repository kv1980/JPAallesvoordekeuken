insert into artikels(naam,aankoopprijs,verkoopprijs,soort,artikelgroepid,houdbaarheid)
	values('testartikelFood',100,200,'F',(select id from artikelgroep where naam ='testgroep'),7);
insert into artikels(naam,aankoopprijs,verkoopprijs,soort,artikelgroepid,garantie)
	values('testartikelNonFood',200,400,'NF',(select id from artikelgroep where naam ='testgroep'),12);
